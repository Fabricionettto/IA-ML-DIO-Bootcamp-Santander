...
Original file is located at
    https://colab.research.google.com/drive/1qNKaHy4PaDoL-LqLmeBB3N9iAf0K2AXe
"""
...
valset = datasets.MNIST('./MNIST_data/', download=True, transform=transform) # Carrega a parte de validação do dataset;
...
class Modelo(nn.Module):
  def _int_(self):
    ...
    self.linear1 = nn.Linear(28*28, 128) # Camada de entrada, 784 neuronios que se liguem a 128;
...
def forward(self,X):
    ...
    X = self.linear3(X) # Função de ativação da camada interna 2 para a camada de saida, desse caso f(x) = x;
